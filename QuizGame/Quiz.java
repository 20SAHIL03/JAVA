import java.awt.event.*; //painting graphics and images
import java.awt.*;   //
import javax.swing.*; // Provides interfaces that develop the input methods that can be used with any Java runtime environment


public class Quiz implements ActionListener{

    //Array of string to hold all the questions
    String[] questions =   {
            "I Speak without a mouth and hear without ears. I have no body, but I come alive with wind. what am I ?",
            "Which one has two zero and two four ?",
            "If 1111 = R , 2222 = T, 3333 = E, 4444 = N, Then what is 5555 = ?",
            ...
            "How many second are there in a year ?"

    };
    //2d array of string to hold all the possible outcomes
    String[][] options =   {
            {"An Echo","Leaves","Storm","Seeds"},
            {"0024","2024","0044","2420"},
            {"I","S","Y","O"},
            {"3","2","1","4"},
            {"128","12,587","12,687","24"}
    };
    char[] answers =      {
            'A',
            'B',
    ...
    int result;
    int seconds=45;
// creating GUI components (visual experience builder for Java applications)
    JFrame frame = new JFrame(); // to diplay all the question
...
// creating constructor
    ...
    public Quiz() {
        ...
        textfield.setBounds(0,0,1080,50);
        ...
        textarea.setBounds(0,50,1080,90);
